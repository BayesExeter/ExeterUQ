...
source_python("../ExeterUQ/TestingMoGP/GetPythonFunctions.py")
n_emulators = 3
n_simulations = 15
n_testing = 10
training <- generate_training_data(n_emulators,n_simulations)
...
a_gp <- MultiOutputGP(training$inputs, training$outputs)
...
Validation <- generate_test_data(n_testing, training$em_params)
...
rm(a_gp)
newGP <- MultiOutputGP("../ExeterUQ/TestingMoGP/FirstPythonEmulators.npz")
